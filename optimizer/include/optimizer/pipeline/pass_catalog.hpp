...
using GlobalPointsToPass = PassDef<passes::GlobalPointsToAnalysis,
                                   AnalysisSpec<Repr::IR, ProductList<>, products::FullPointsToSet,
                                                products::TranslationAll, names::global_points_to>>;

using LocalPointsToPass = PassDef<
        passes::LocalPointsToAnalysis,
        AnalysisSpec<
                Repr::IR, ProductList<products::GlobalPointsToProgram>, products::LocalPointsToSet,
                utils::set_union_unique_t<products::TranslationAll, products::GlobalPointsToSet>,
...
using DumpPointsToPass =
        PassDef<passes::DumpPointsTo, DebugSpec<Repr::IR, products::FullPointsToSet, ProductList<>,
